...
import { routeMetadata, SITE_ORIGIN } from "../../lib/site";
import LegalShell from "../components/legal-shell";

export const metadata: Metadata = routeMetadata(
  "/blog",
  "Blog — AI Receptionist Insights for Trade Businesses | Vectolift",
...
function getAuthorName(author: string | { name: string }) {
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-4 p-4 max-lg:p-2">
              ...
              <div className="flex items-center gap-2 text-xs text-color-002/50 mt-auto">
                <span>{getAuthorName(featured.author)}</span>
                <span>·</span>
