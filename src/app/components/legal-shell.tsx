...
export default function LegalShell({ children }: LegalShellProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-color-001 text-color-002 [font-family:avantt,_'avantt_Fallback',_system-ui,_sans-serif]">
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 bg-color-001/90 backdrop-blur-xl border-b border-white/5">
        <nav className="mx-auto flex h-18 w-full max-w-324 items-center justify-between px-6 md:px-18 max-lg:px-5">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium">
            <Link className="hover:text-primary transition-colors" href="/#technology">Technology</Link>
            <Link className="hover:text-primary transition-colors" href="/#benefits">Benefits</Link>
            <Link className="hover:text-primary transition-colors" href="/calculator">Calculator</Link>
          ...
          <div className="flex md:hidden items-center gap-3">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200/20 text-color-002 hover:bg-slate-800/20 transition-colors"
