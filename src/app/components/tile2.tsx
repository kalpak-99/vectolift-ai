...
export default function Tile2({ d, cids, styles }: { d: Tile2Data; cids: string[]; styles: Tile2Styles }) {
  return (
    <div data-cid={cids[0]} className={cn("h-39 flex min-w-px p-10 flex-col justify-center items-center flex-1 gap-2.5 text-color-002 text-center max-lg:shrink-0 max-lg:min-w-0 max-lg:grow-[initial] max-lg:basis-[initial] max-md:p-5 max-md:h-auto max-md:last:col-span-2", styles.className)}>
