...
export default function ListenDemoBar() {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      />
      <div className="flex w-full max-w-md items-stretch overflow-hidden rounded-xl border border-white/15 bg-black/30 shadow-[0_8px_32px_rgba(0,0,0,0.25)] backdrop-blur-xl max-md:max-w-none">
        {/* Left: mic + waveform */}
