...
export default function ContactModal({ open, onClose }: ContactModalProps) {
  ...
  return (
    <dialog
      ref={dialogRef}
      className="fixed inset-0 z-[200] m-auto w-[calc(100%-2rem)] max-w-md rounded-2xl border border-slate-200/80 bg-white p-0 text-slate-900 shadow-[0_25px_70px_-15px_rgba(0,0,0,0.18),0_0_1px_rgba(0,0,0,0.1)] backdrop:bg-slate-900/40 backdrop:backdrop-blur-md open:flex open:flex-col"
      onClose={onClose}
      onClick={(e) => {
