...
export default function Page() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-[100] lg:hidden transition-opacity duration-300 ${mobileMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
      ...
      <nav
        className={`fixed top-0 right-0 bottom-0 w-72 max-w-[85vw] bg-white border-l border-slate-200/80 shadow-2xl flex flex-col z-[101] lg:hidden transition-transform duration-300 ease-out ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
      ...
      <div className="min-h-screen flex relative flex-col [font-family:avantt,_'avantt_Fallback']" data-cid="n1">
        ...
        <main className="h-full block flex-1" data-cid="n3" id="main-content">
            ...
            <nav className="block py-4 px-18 bg-surface-2 [backdrop-filter:blur(40px)] max-lg:py-3 max-lg:px-5" data-cid="n12" data-component="nav">
              <div className="flex max-w-360 justify-between items-center mx-auto w-full" data-cid="n13">
                ...
                <div className="flex items-center gap-2" data-cid="n32">
                  <a
                    className="hidden px-3 rounded-lg justify-center items-center text-color-002 text-[15px] font-medium leading-[1.3125rem] cursor-pointer h-10 md:max-lg:inline-flex md:max-lg:h-8"
                    href="/faq"
                  >
                    FAQ
                  </a>
                  <button
                    type="button"
                    className="inline-flex px-4 rounded-lg justify-center items-center text-color-003 text-[15px] font-medium leading-[1.3125rem] bg-primary cursor-pointer h-10 max-lg:h-8 hover:opacity-90 transition-opacity max-md:hidden"
                    data-cid="n33"
                  ...
                  <button className="hidden min-w-0 shrink-0 text-color-002 text-center cursor-pointer max-lg:h-6 max-lg:block" data-cid="n35" aria-label="Open menu" type="button" onClick={() => setMobileMenuOpen(true)}>
                    <Icon2 cid={"n36"} />
                  </button>
                </div>
              </div>
          ...
          <div className="block" data-cid="n38" id="page-content">
            <section className="min-h-160 grid relative overflow-hidden text-color-001 bg-color-002 aspect-[1.803] w-full grid-cols-1 grid-rows-[auto] max-lg:min-h-0 max-md:aspect-auto md:max-lg:aspect-[1.082] 2xl:min-h-216 2xl:aspect-[2.222]" data-cid="n39" id="hero">
              <div className="h-full block absolute top-0 inset-x-0 z-0 min-w-0" data-cid="n40" aria-hidden="true">
                ...
                <img
                  className="w-full h-full block absolute top-0 left-0 max-w-full overflow-clip object-cover object-[50%_50%] align-middle pointer-events-none max-md:object-[30%_20%]"
                  data-cid="n41"
                  alt=""
                  aria-hidden="true"
              ...
              {/* Overlay — left gradient on desktop, full dark gradient on mobile for text readability */}
              <div
                ...
                aria-hidden="true"
              />
              {/* Mobile-only: stronger bottom-up gradient so text is always readable */}
              <div
                className="hidden max-md:block h-full absolute top-0 inset-x-0 z-2 pointer-events-none"
                style={{
                  background:
                    "linear-gradient(to top, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.55) 40%, rgba(0,0,0,0.15) 70%, rgba(0,0,0,0) 100%)",
                }}
                aria-hidden="true"
              />
              <div className="grid relative z-40 aspect-[1.803] grid-cols-1 grid-rows-[auto] max-md:aspect-auto md:max-lg:aspect-[1.082] 2xl:aspect-[2.222]" data-cid="n45">

                <div className="max-w-324 h-177.5 min-h-177.5 flex relative z-3 pt-15 pb-9 px-18 justify-start items-center col-start-1 row-start-1 mx-auto w-full max-md:h-auto max-md:min-h-[520px] max-md:pt-10 max-md:pb-8 max-md:px-5 max-md:items-end 2xl:h-216" data-cid="n46">
                  {/* LEFT: Hero copy */}
                  <div className="flex flex-col items-start gap-6 w-full max-w-[676px] shrink-0 max-md:gap-4" data-cid="n47">
                    <div className="flex flex-col items-start gap-3 w-full max-md:gap-2.5" data-cid="n48">
                      <h1 className="m-0 block text-[80px] font-semibold leading-[1.05] tracking-[-3.2px] w-full max-w-[676px] text-white [font-family:avantt,_'avantt_Fallback',_system-ui,_sans-serif] max-md:text-[2rem] max-md:tracking-[-1.2px] max-md:leading-[1.1] md:max-lg:text-[3.5rem]" data-cid="n49" data-component="heading">
                        Never miss another call.
                      </h1>
                      <p className="m-0 block text-[18px] leading-[1.4] w-full max-w-[508px] text-white/90 [font-family:avantt,_'avantt_Fallback',_system-ui,_sans-serif] max-md:text-sm max-md:leading-[1.5] max-md:text-white/80" data-cid="n50">
                        AI receptionist that answers every call and books jobs — naturally, 24/7.
                      </p>
                      {/* CTA button */}
                      <button
                        type="button"
                        className="inline-flex px-5 rounded-xl justify-center items-center text-color-003 text-[15px] font-semibold leading-[1.3125rem] bg-primary cursor-pointer h-12 max-md:self-stretch max-md:h-12 max-md:rounded-xl max-md:text-base hover:opacity-90 transition-opacity shadow-lg shadow-primary/30 max-md:mt-1"
                        data-cid="n51"
                        data-component="button"
                        onClick={() => setContactOpen(true)}
                      >
            ...
            <section className="block px-18 bg-color-001 max-md:px-6 md:max-lg:px-14.5" data-cid="n99" id="technology">
              <div className="flex max-w-324 px-18 flex-col mx-auto max-md:p-8 max-md:gap-8 md:max-lg:p-14.5 md:max-lg:gap-14.5" data-cid="n100">
                ...
                <div className="flex pt-24 justify-between items-center gap-6 max-lg:flex-col max-lg:pt-0 max-lg:[justify-content:initial] max-lg:[align-items:initial]" data-cid="n106">
                  <div className="w-100 flex flex-col shrink-0 gap-4 max-md:w-full max-lg:shrink-[initial] md:max-lg:w-134" data-cid="n107">
                    ...
                    <h3 className="block text-color-002 text-[2.5rem] font-medium leading-10 tracking-[-1.6px] max-md:max-w-none max-md:text-xl max-md:leading-6 max-md:tracking-[-0.72px] md:max-lg:text-2xl md:max-lg:tracking-[-0.96px] md:max-lg:leading-[inherit]" data-cid="n109" data-component="heading">
                      Turn every call into a booked job.
                    </h3>
                    <p className="block max-w-130 text-color-002 text-sm leading-[1.25rem] max-md:max-w-none max-md:text-sm max-md:leading-[1.35rem]" data-cid="n110">
                ...
                <div className="flex py-24 flex-row-reverse justify-between items-center gap-6 max-lg:flex-col max-lg:py-0 max-lg:[justify-content:initial] max-lg:[align-items:initial]" data-cid="n114">
                  <div className="w-100 flex flex-col shrink-0 gap-4 max-md:w-full max-lg:shrink-[initial] md:max-lg:w-134" data-cid="n115">
                    ...
                    <h3 className="block text-color-002 text-[2.5rem] font-medium leading-10 tracking-[-1.6px] max-md:max-w-none max-md:text-xl max-md:leading-6 max-md:tracking-[-0.72px] md:max-lg:text-2xl md:max-lg:tracking-[-0.96px] md:max-lg:leading-[inherit]" data-cid="n117" data-component="heading">
                      More calls answered. More jobs booked. Less time on the phone.
                    </h3>
                    <p className="block max-w-130 text-color-002 text-sm leading-[1.25rem] max-md:max-w-none max-md:text-sm max-md:leading-[1.35rem]" data-cid="n118">
