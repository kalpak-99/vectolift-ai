...
export const metadata = routeMetadata(
  "/privacy",
  "Privacy Policy - Vectolift",
  "Vectolift privacy policy for the website and AI receptionist services.",
);

export default function PrivacyPage() {
  const policyPath = path.join(process.cwd(), "src", "app", "legal-content", "privacy-policy.txt");
