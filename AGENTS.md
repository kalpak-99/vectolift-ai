...
This is the Vectolift marketing site. It is a static Next.js App Router project with locally hosted assets, route metadata, crawler files, and structured data.
...
- `src/app/ditto.css`: generated fidelity CSS for layout, pseudos, keyframes, and interaction states. Small visual tweaks are reasonable; broad rewrites can break the rendered page.
...
`src/app/ditto` contains generated runtime utilities for captured interactions and motion. Current runtime utilities: DropdownMenu. Do not casually rewrite these files; they are plumbing for stable generated anchors in delivered pages.
